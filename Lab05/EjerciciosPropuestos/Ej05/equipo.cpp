...
string EquipoBaloncesto::getMejorAnotadorTriples() const {
    return mejorAnotadorTriples;
}

int EquipoBaloncesto::getNumeroTriples() const {
    return numeroTriples;
}

int EquipoBaloncesto::calcularPuntos() const {
    return victorias * 3;
}
...
string EquipoFutbol::getGoleador() const {
    return goleador;
}

int EquipoFutbol::getNumeroGoles() const {
    return numeroGoles;
}

int EquipoFutbol::calcularPuntos() const {
